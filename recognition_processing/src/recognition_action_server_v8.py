...
class Count(smach.State):
    ...
    def execute(self, userdata):
        ...
        rospy.sleep(1.0)
        bbox = Recognition_Tools_V8.bbox
        userdata.bbox_out = bbox
        object_count = Recognition_Tools_V8.countObject(RecognitionCountRequest(userdata.target_name_in), bbox).num
...
class Find(smach.State):
    ...
    def execute(self, userdata):
        ...
        find_flg = Recognition_Tools_V8.findObject(RecognitionFindRequest(userdata.target_name_in)).result
...
class Localize(smach.State):
    ...
    def execute(self, userdata):
        ...
        object_centroid = Recognition_Tools_V8.localizeObject(localize_request).point
